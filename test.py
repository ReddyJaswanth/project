keyword_documents = {
    ...
    'graphic design contract': {
        ...
        'description':"Here is a sample Graphic Design Contract: GRAPHIC DESIGN CONTRACTThis Graphic Design Contract (""Contract"") is made and entered into on [DATE] (""Effective Date"") by and between [YOUR COMPANY NAME] (""Designer"") and [CLIENT NAME] (""Client"").1. PROJECT OVERVIEW The Designer agrees to provide graphic design services to the Client, as described in the attached Project Scope document."
    },
    ...
    'nanny': {
        'file':'Agreements\Nanny-Contract-Template.pdf',
    ...
    'nondisclosure': {
        'file':'Agreements\Non-Disclosure-Agreement-Template-Signaturely.pdf',
    ...
    'retainer': {
        ...
        'description':"RETAINER AGREEMENT This Retainer Agreement (""Agreement"") is made and entered into on [DATE] (""Effective Date"") by and between [YOUR COMPANY NAME] (""Service Provider"") and [CLIENT NAME] (""Client"")."
    },
    ...
    'video production': {
        ...
        'description':"VIDEO PRODUCTION PROPOSAL CONTRACT This Video production Proposal Contract (""Agreement"") is made and entered into on [DATE] (""Effective Date"") by and between [YOUR COMPANY NAME] (""Producer"") and [CLIENT NAME] (""Client"").1. PROJECT OVERVIEWThe Producer agrees to produce a video project (the ""Project"") for the Client, as described in the attached proposal (the ""Proposal"")."
    },
